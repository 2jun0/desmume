...
void updateDualshock4(BYTE rawData[], DWORD byteCount, WCHAR* deviceName, OutputData* outputData)
{
	memset(&dsInputState, 0, sizeof(dsInputState));
	...
	dsInputState.LX = rawData[offset + 1];
	dsInputState.LY = rawData[offset + 2];
	dsInputState.RX = rawData[offset + 3];
	dsInputState.RY = rawData[offset + 4];
	dsInputState.LT = rawData[offset + 8];
	dsInputState.RT = rawData[offset + 9];
	dsInputState.dpad = 0b1111 & rawData[offset + 5];

	switch (dsInputState.dpad) {
		case 0: dsInputState.buttons[DSBTN_UP] = true; break;
		case 1: dsInputState.buttons[DSBTN_UP] = true; dsInputState.buttons[DSBTN_RIGHT] = true; break;
		case 2: dsInputState.buttons[DSBTN_RIGHT] = true; break;
		case 3: dsInputState.buttons[DSBTN_RIGHT] = true; dsInputState.buttons[DSBTN_DOWN] = true; break;
		case 4: dsInputState.buttons[DSBTN_DOWN] = true; break;
		case 5: dsInputState.buttons[DSBTN_DOWN] = true; dsInputState.buttons[DSBTN_LEFT] = true; break;
		case 6: dsInputState.buttons[DSBTN_LEFT] = true; break;
		case 7: dsInputState.buttons[DSBTN_LEFT] = true; dsInputState.buttons[DSBTN_UP] = true; break;
	}
	...
	if (1 & (rawData[offset + 5] >> 4)) dsInputState.buttons[DSBTN_SQUARE] = true;
	if (1 & (rawData[offset + 5] >> 5)) dsInputState.buttons[DSBTN_X] = true;
	if (1 & (rawData[offset + 5] >> 6)) dsInputState.buttons[DSBTN_O] = true;
	if (1 & (rawData[offset + 5] >> 7)) dsInputState.buttons[DSBTN_TRIANGLE] = true;
	if (1 & (rawData[offset + 6] >> 0)) dsInputState.buttons[DSBTN_L1] = true;
	if (1 & (rawData[offset + 6] >> 1)) dsInputState.buttons[DSBTN_R1] = true;
	if (1 & (rawData[offset + 6] >> 2)) dsInputState.buttons[DSBTN_L2] = true;
	if (1 & (rawData[offset + 6] >> 3)) dsInputState.buttons[DSBTN_R2] = true;
	if (1 & (rawData[offset + 6] >> 4)) dsInputState.buttons[DSBTN_SHARE] = true;
	if (1 & (rawData[offset + 6] >> 5)) dsInputState.buttons[DSBTN_OPTIONS] = true;
	if (1 & (rawData[offset + 6] >> 6)) dsInputState.buttons[DSBTN_L3] = true;
	if (1 & (rawData[offset + 6] >> 7)) dsInputState.buttons[DSBTN_R3] = true;
	if (1 & (rawData[offset + 7] >> 0)) dsInputState.buttons[DSBTN_PS] = true;
	if (1 & (rawData[offset + 7] >> 1)) dsInputState.buttons[DSBTN_TOUCHPAD] = true;
...
LRESULT CALLBACK DSWindowProcedure(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
void dsInput_init()
{
	...
	wnd.lpfnWndProc = DSWindowProcedure;
